...
const propertyDetails = [
  ...
  },
  {
    ...
    baths: "1",
    sqft: "1,725",
    address: `532 Spoleto Drive Pacific Palisades, CA 90272`,
    price: "$225,000",
  },
  {
    property: "3",
    ...
    baths: "3",
    sqft: "3,560",
    address: `2261 Victoria Avenue Oxnard, CA 93035`,
    price: "$825,000",
  },
  {
    property: "4",
    ...
    baths: "1",
    sqft: "1,325",
    address: `2176 E Main Street #111 Ventura, CA 93001`,
    price: "$432,000",
  },
  {
    property: "5",
    ...
    baths: "2",
    sqft: "2,201",
    address: `1322 Alessandro Drive Newbury Park, CA 91320`,
    price: "$595,000",
  },
  {
    property: "6",
    ...
    baths: "2",
    sqft: "1,054",
    address: `119 N Driskill Street Oxnard, CA 93030`,
    price: "$309,900",
  },
  {
    property: "7",
    ...
    baths: "2.5",
    sqft: "2,169",
    address: `591 Hollyburne Lane Thousand Oaks, CA 91360`,
    price: "$622,000",
  },
  {
    property: "8",
  ...
  },
  {
    ...
    baths: "2",
    sqft: "2,905",
    address: `2531 Apple Lane #86 Oxnard, CA 93036`,
    price: "$821,000",
  },
  {
    property: "11",
...
const b = [];
const PropertiesType = [propertyDetails.map((item) => item.type)];

const compareArrays = (a, b) => {
  return JSON.stringify(a) === JSON.stringify(b);
};

const nested = PropertiesType[0];

const ListtingTabs = ({ pageName }) => {
